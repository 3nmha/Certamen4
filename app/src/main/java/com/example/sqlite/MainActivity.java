...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapterXD = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, UbicacionS );
        Ubicacion.setAdapter(adapterXD);
    ...
    public void EliminarProducto(View view){
        ...
        if (!IDProducto.isEmpty()){
            ...
            if (Eliminar == 1){
                ...
                Toast.makeText(this, "Se eliminaron los campos ", Toast.LENGTH_SHORT).show();
                BaseDatos.close();
            } else {
